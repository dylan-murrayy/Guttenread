...
def main() -> None:
    ...
    system_message = (
        ...
        "3. Decide which titles are real books and which entries to ignore (e.g. comments).\n"
        "4. Call the `search_gutenberg` tool with a clean list of titles.\n"
        "5. Once you have tool results, present a nicely formatted summary of the reading list, "
        "including for each book: title, author(s), language(s), and Gutenberg URL. "
        "If text excerpts were downloaded, you may also provide very brief summaries."
    )
